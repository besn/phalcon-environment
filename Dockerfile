...
RUN /usr/bin/apt-get install -yqq make rsync git wget supervisor nginx memcached nodejs yarn unzip \
    php7.2-bz2 php7.2-cli php7.2-common php7.2-curl php7.2-fpm php7.2-gd php7.2-imap php7.2-intl \
    php7.2-json php7.2-mbstring php7.2-mysql php7.2-mongodb php7.2-opcache php7.2-phalcon \
